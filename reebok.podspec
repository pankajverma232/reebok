...
Pod::Spec.new do |s|
  s.name             = 'reebok'
  s.version          = '0.1.0'
  s.summary          = 'A short description of reebok.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/reebok'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'pankaj verma' => 'pankaj.verma@timesinternet.in' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/reebok.git', :tag => s.version.to_s }
